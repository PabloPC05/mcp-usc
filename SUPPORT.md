...
Puedes adjuntar la salida de `uv run mcp-usc doctor` tras revisarla. El comando no imprime valores de
credenciales ni contacta con el Campus. No adjuntes la salida de herramientas que contenga nombres,
cursos, mensajes, calificaciones o entregas reales.
